...
class Catalogues
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Comment::class, mappedBy="catalogues", orphanRemoval=true)
     */
    private $comments;
    ...
    public function removeComment(Comment $comment): self
    {
        if ($this->comments->removeElement($comment)) {
            ...
            if ($comment->getCatalogues() === $this) {
                $comment->setCatalogues(null);
            }
        }
